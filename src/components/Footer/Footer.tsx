    ...
    <div className='h-full md:h-[505px] flex flex-col md:flex-row items-center justify-center w-full bg-white '>
        <div className='h-full md:h-[419px] w-[90%] flex flex-col  justify-between md:w-[1240px] bg-white '>
          <div className='h-full md:h-[312px] py-2 w-[90%] flex flex-col md:flex-row mx-auto md:mx-0 justify-between md:w-[1133px] bg-white'>
           ...
           {/* 1 row */}
            <div className='h-full md:h-[312px] w-[68px] space-y-2 md:space-y-0 flex flex-col justify-between '>
              ...
              <Link href ="/" className=' hover:text-golden hover:underline font-medium text-[16px] text-black' > <li>Home </li> </Link>
              <Link href ="/shop" className=' hover:text-golden hover:underline font-medium text-[16px] text-black' > <li>Shop </li> </Link>
              <Link href ="/blog" className=' hover:text-golden hover:underline font-medium text-[16px] text-black' > <li>Blog </li> </Link>
              <Link href ="/contact" className=' hover:text-golden hover:underline font-medium text-[16px] text-black' > <li>Contact </li> </Link>
           ...
           <div className='h-full md:h-[242pxx] w-[142px] flex flex-col space-y4 md:space-y-16'>
           ...
           {/* 3 row */}
            <div className='md:h-[101px] w-[286px] flex justify-between flex-col '>
              ...
              <div className='flex justify-between'>
                <input type="text" placeholder='Enter your email' className='w-[60%] h-[34px] px-2 border-b-2 border-black' />
                <button className='p-2 border-b-2  hover:border-2 border-myblack '>Subscribe</button>
              </div>
            </div>
          ...
          <div className='h-[59px]  md:w-full border-t-2 flex items-end border-gray-400   '>
            <p className='text-[16px] font-normal text-black'>2023 furino. All rights reverved</p>
          </div>
        </div>
    </div>
